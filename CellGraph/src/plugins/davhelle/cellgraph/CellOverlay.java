...
public class CellOverlay extends EzPlug implements EzVarListener<OverlayEnum>{
	...
	private EzVarInteger varFlowMode;
...
//		super.addEzComponent(groupDescription);
	...
	private EzGroup initializeOverlayParameters(){
		...
		// Tracking Flow
		varFlowMode = new EzVarInteger("Mode",0,0,2,1);
		EzGroup groupTrackingFlow = new EzGroup("Overlay elements",
				varFlowMode);
		...
		varPlotting.addVisibilityTriggerTo(groupTrackingFlow, OverlayEnum.TRACKING_FLOW);
	...
	private void addStGraphOverlay(SpatioTemporalGraph stGraph,
		...
		case CELL_PROJECTION:
			...
			break;
		case TRACKING_FLOW:
			sequence.addOverlay(new FlowOverlay(stGraph, varFlowMode.getValue()));
			break;
		case ELLIPSE_FIT:
			sequence.addOverlay(
